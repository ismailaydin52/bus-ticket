					...
					<div class="col-lg-5">
						<div class="card card-login mx-auto mt-10">
							...
							<div class="card-body" align="left">
																 <form action="http://localhost/myci5/public/login/forgetpassword" method="post" >
				                    ...
				                    <small class="text-danger pl-3"></small>				                    <button class="btn btn-primary btn-user btn-block">
				                      Reset Password
				                    </button>
				                  </form>
								<div class="text-center">
									<p><a class="d-block small mt-3" href="http://localhost/myci5/public/kay%C4%B1tol">Register</a>
									<a class="d-block small" href="http://localhost/myci5/public/login">Login</a>
									</p>
								</div>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-lg-3  col-md-6 col-sm-6">
							<div class="single-footer-widget">
								...
								<p>
			                     Uzun yolculuklarınızın değişmez adresi Umuttepe Turizim sağlıklı günler dileriz.
								</p>
							</div>
						</div>
...
<script>swal("Empty", "No Pending Tickets Found", "error");</script><!--Start of Tawk.to Script-->
