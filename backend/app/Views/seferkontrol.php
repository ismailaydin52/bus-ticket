	...
	<header id="header" id="home" style="background-color:#007FFF">
		<div class="container">
			<div class="row align-items-center justify-content-between d-flex">
				<div id="logo">
					<a href="index.html">
						<h3> <i class="fas fa-ticket-alt" style="color: white;"></i> <b style="color: azure;">Umuttepe Turizim</b></h3>
					</a>
				</div>
					...
					<div class="card mb-5">
						...
						<div class="card-body">
							<div class="alert alert-warning" role="alert">
								<p><b>IMPORTANT!!</b></p>
								<P>Before Buying Tickets, Please have a look>> <b><i data-toggle="modal" data-target="#exampleModal">How to book?</i></b></P>
							</div>
					...
					<div class="card mb-10">
						...
						<div class="card-body">
							<table class="table table-bordered table-condensed" style="font-size:12px;" id="mydata" class='block'>
								...
								<tbody>
									<tr>
										<td style="text-align:center;vertical-align:middle" class="colorText">
											Kocaeli-06:00</td>
										<td style="vertical-align:middle;" class="colorText">İstanbul-08:00</td>
									</tr>
									<tr>
										<td style=" text-align:center;vertical-align:middle" class="colorText">
											Kocaeli-14:00</td>
										<td style="vertical-align:middle;" class="colorText">İstanbul-16:00</td>
									</tr>
									<tr>
										<td style=" text-align:center;vertical-align:middle" class="colorText">
											Kocaeli-08:00</td>
										<td style="vertical-align:middle;" class="colorText">İzmir-14:00</td>
									</tr>
									<tr>
										<td style=" text-align:center;vertical-align:middle" class="colorText">
											Kocaeli-13:00</td>
										<td style="vertical-align:middle;" class="colorText">İzmir-00:00</td>
									</tr>
									<tr>
										<td style=" text-align:center;vertical-align:middle" class="colorText">
											Kocaeli-21:00</td>
										<td style="vertical-align:middle;" class="colorText">İzmir-04:00</td>
									</tr>
									<tr>
										<td style=" text-align:center;vertical-align:middle" class="colorText">
											İstanbul-08:00</td>
										<td style="vertical-align:middle;" class="colorText">Kocaeli-12:00</td>
									</tr>
									<tr>
										<td style=" text-align:center;vertical-align:middle" class="colorText">
											İstanbul-16:00</td>
										<td style="vertical-align:middle;" class="colorText">Kocaeli-20:00</td>
									</tr>
									<tr>
										<td style=" text-align:center;vertical-align:middle" class="colorText">
											İzmir-04:00</td>
										<td style="vertical-align:middle;" class="colorText">istanbul-12:00</td>
									</tr>
									<tr>
										<td style=" text-align:center;vertical-align:middle" class="colorText">
											İzmir-12:00</td>
										<td style="vertical-align:middle;" class="colorText">İstanbul-22:00</td>
									</tr>
									<tr class=" seferler">
										<td style="text-align:center;vertical-align:middle" class="colorText">
											İzmir-20:00</td>
										<td style="vertical-align:middle;" class="colorText">İstanbul-05:00</td>
									</tr>
									<tr class=" seferler">
										<td style="text-align:center;vertical-align:middle" class="colorText">
											İzmir-12:00</td>
									...
									<tr class=" seferler">
										<td style="text-align:center;vertical-align:middle" class="colorText">
											İzmir-04:00</td>
										<td style="vertical-align:middle;" class="colorText">Zonguldak-12:00</td>
									</tr>
									<tr class=" seferler">
										<td style="text-align:center;vertical-align:middle" class="colorText">
											İzmir-12:00 </td>
										<td style="vertical-align:middle;" class="colorText">Zonguldak-20:00</td>
									</tr>
								</tbody>
							</table>
						</div>
...
<script>
		...
		if (selectedText) {
			...
			tableCells.forEach(cell => {
				if (cell.innerText === selectedText) {
					cell.style.backgroundColor = 'yellow'; // Renk seçimi
				}
			});
		}
	});
	...
	window.addEventListener('DOMContentLoaded', (event) => {
		...
		els.forEach(function(cell) {
			if (cell.textContent.toLowerCase().includes(localStorage.getItem("kalkis").toLowerCase())) {
				cell.style.color = 'red';
			}
			if (cell.textContent.toLowerCase().includes(localStorage.getItem("varis").toLowerCase())) {
