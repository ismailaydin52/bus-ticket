		    	...
		    	<div class="row align-items-center justify-content-between d-flex">
			      ...
			      <nav id="nav-menu-container">
			        <ul class="nav-menu sf-js-enabled sf-arrows" style="touch-action: pan-y;">
			          ...
			          <li class="menu"><a href="http://localhost/myci5/public/seferkontrol">Bilet Kontrolü</a></li> 
			          				      	<li class="menu-has-children"><a href="#" class="sf-with-ul">Hi, ismail ayd?n</a>
								...
								<div class="card-body" align="left">
									<div class="row">
										<div class="col-sm-8">
											...
											<p class="card-text">ismail ayd?n</p>
										...
										<div class="col-sm-14">
											...
											<p><a href="http://localhost/BusTicket-CI/profile/changepassword/CA0024" class="btn btn-primary">Change Password</a></p>
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="http://localhost/BusTicket-CI/profile/editprofile" method="post" enctype="multipart/form-data">
									<div class="card-body">
										<div class="row">
											<div class="col-sm-14">
	...
	$(":submit").click(function (e) {
		...
		<nav id="mobile-nav">
			        <ul class="" style="touch-action: pan-y;" id="">
			          <li class="menu"><a href="http://localhost/BusTicket-CI/">Home</a></li>
			          <li><a href="http://localhost/BusTicket-CI/tiket">Make Bookings</a></li>
			          <li class="menu"><a href="http://localhost/BusTicket-CI/tiket/cektiket">Check Tickets</a></li>
