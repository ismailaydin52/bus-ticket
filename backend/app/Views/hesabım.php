...
<head>
	...
	<body style="display: block;"><button type="button" id="mobile-nav-toggle"><i class="lnr lnr-menu"></i></button>
		...
		<header id="header">
		    	...
		    	<div class="row align-items-center justify-content-between d-flex">
			      ...
			      <nav id="nav-menu-container">
			        <ul class="nav-menu sf-js-enabled sf-arrows" style="touch-action: pan-y;">
			          ...
			          <li><a href="http://localhost/myci5/public/kayıtol">rezervasyon yap</a></li>
			          <li class="menu"><a href="">bilet kontrolü</a></li>
			          				      	<li class="menu-has-children"><a href="#" class="sf-with-ul">merhaba, nick</a>
						<ul style="display: none;">
							<li><a href="http://localhost/BusTicket-CI/profile/profilesaya/CA0024"><i class="fas fa-id-card"></i> Hesabım</a></li>
							<li><a href="http://localhost/BusTicket-CI/profile/tiketsaya/CA0024"><i class="fas fa-ticket-alt"></i> Biletlerim</a></li>
							<li><a href="http://localhost/BusTicket-CI/login/logout"><i class="fas fa-sign-out-alt"></i> çıkış</a></li>
						</ul>
						</li>
				      			        </ul>
								...
								<div class="card-body" align="left">
									<div class="row">
										<div class="col-sm-8">
											...
											<p class="card-text">ismailaydin52002@gmail.com</p>
											<h5 class="card-title">Tel No.</h5>
											<p class="card-text">123 123</p>
										</div>
										<div class="col-sm-14">
											...
											<p><a href="http://localhost/BusTicket-CI/profile/changepassword/CA0024" class="btn btn-primary">şifre değiştir</a></p>
										...
										<div class="row">
											<div class="col-sm-14">
												...
												<div class="row form-group">
													...
													<input type="text" class="form-control" name="nama" value="ismail ayd?n">
												</div>
												<div class="row form-group">
													<label for="nama" class="control-label">E posta</label>
													<input type="email" class="form-control" name="email" value="ismailaydin52002@gmail.com">
												</div>
												<div class="row form-group">
													<label for="nama" class="control-label">Telefon numarası</label>
													<input type="text" class="form-control" name="hp" value="123">
												</div>
												<div class="row form-group">
													<label for="nama" class="control-label">Adres</label>
													<input type="text" class="form-control" name="alamat" value="saddad">
												</div>
												<div class="row form-group">
            ...
            <p class="footer-text m-0"><span>© 2024 umuttepe Turizim</span> </p>
	...
	$(":submit").click(function (e) {
		...
		<nav id="mobile-nav">
			        <ul class="" style="touch-action: pan-y;" id="">
			          ...
			          <li><a href="http://localhost/myci5/public/seferkontrol">Make Bookings</a></li>
			          <li class="menu"><a href="">Check Tickets</a></li>
						...
						<ul style="display: none;">
							...
							<li><a href="http://localhost/BusTicket-CI/profile/tiketsaya/CA0024"><i class="fas fa-ticket-alt"></i> My Ticket</a></li>
							<li><a href="http://localhost/BusTicket-CI/login/logout"><i class="fas fa-sign-out-alt"></i> Logout</a></li>
						</ul>
						</li>
				      			        </ul>
