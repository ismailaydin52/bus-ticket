...
<html lang="zxx" class="no-js">
  <head>
    ...
    <style type="text/css">
      ...
      background-image: url("https://www.kocaeli.bel.tr/webfiles/userfiles/images/icerikler/Turizm%20Sube/foto%C4%9Fraf%2011.JPG") !important;
  ...
  <body style="background-image: url(https://www.kocaeli.bel.tr/webfiles/userfiles/images/icerikler/Turizm%20Sube/foto%C4%9Fraf%2011.JPG);">
    ...
    <!-- #header -->
    <!-- start banner Area -->
    <section class="banner-area relative section-gap relative" id="home" style="background-image: url(https://www.kocaeli.bel.tr/webfiles/userfiles/images/icerikler/Turizm%20Sube/foto%C4%9Fraf%2011.JPG);">
      <div class="container">
        ...
        >
          <div class="banner-content col-lg-7 col-md-12">
            <h2 class="text-white">Umuttepe Turizim</h2>
            <p class="text-white">
              Umuttepe Turizim ile sağlık ve güvenle seyehat edin. Uzun yolculuklarınızın vazgeçilmez adresi Umuttepe Turizim
            </p>
            <a
              href="http://localhost/myci5/public/güzergahlar"
              class="btn btn-danger text-uppercase"
              >Güzergahları Getir</a 
            >
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="single-footer-widget">
              ...
              <p>
                Umuttepe Turizim ile kaliteli seyehat edin.
                İyi yolculuklar.Sitemize üye olmayı unutmayın
              </p>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="single-footer-widget">
              <h4 class="text-white"> İletişime Geçin</h4> 
              <p></p>
              <p class="number">
