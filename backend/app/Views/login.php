...
<html lang="zxx" class="no-js">
	...
	<body class="">
		...
		<header id="header" id="home">
		  ...
		  </header><!-- #header -->			<section class="generic-banner">
			<div class="container">
				<div class="row height align-items-center justify-content-center">
					<div class="col-lg-5">
						<div class="card card-login mx-auto mt-10">
							<div class="card-header">Üye Giriş Paneli</div> 
							<div class="card-body" align="left">
																<form action="http://localhost/BusTicket-CI/login/cekuser" method="post">
								...
								<div class="text-center">
									<p><a class="d-block mt-3" href="http://localhost/myci5/public/kay%C4%B1tol">Kayıt Ol</a> 
									<hr>
									<b><a class="d-block mt-3" style="font-size:15px;" href="http://localhost/myci5/public/adminlogin">Admin Girişi</a></b>
									<a class="d-block small" href="http://localhost/myci5/public/forgetpassword">Forgot Password</a> 
								</p>
					...
					<div class="row">
						<div class="col-lg-3  col-md-6 col-sm-6">
							<div class="single-footer-widget">
								...
								<p>
								Umuttepe Turizim ile sağlık ve güvenle seyehat edin.Uzun yolculuklarınızın değişmez adresi Umuttepe Turizim
								</p>
							</div>
						</div>
